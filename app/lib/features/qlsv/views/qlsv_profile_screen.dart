...
class QlsvProfileScreen extends StatefulWidget {
  final Map<String, dynamic> profile;

  const QlsvProfileScreen({super.key, required this.profile});

  @override
  State<QlsvProfileScreen> createState() => _QlsvProfileScreenState();
}

class _QlsvProfileScreenState extends State<QlsvProfileScreen> {
